...
In a _two-person finite game_ with P1 as the leader, [[strategy]] $\gamma^{1*} \in \Gamma^1$ is called a **Stackelberg equilibrium strategy** for the leader, if
...
1. T. Başar and G.J. Olsder, _Dynamic Noncooperative Game Theory_, 2nd edition, Classics in Applied Mathematics, SIAM, Philadelphia, 1999, pp. 131-148, 196-197.
