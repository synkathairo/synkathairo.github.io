...
- if [[P versus NP problem|P≠NP]], then by _Ladner's theorem_ there exists problems which are _$\mathbf{NP}$-intermediate_ (NPI), i.e. between NP and NPC in complexity
