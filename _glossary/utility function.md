...
If the set of outcomes is _finite_, any complete, reflexive, and transitive preference relation can be easily represented by a utility function.
...
1. M. Maschler, E. Solan, and Shmuel Zamir, _Game Theory_, Cambridge University Press, 2013, p. 11.
