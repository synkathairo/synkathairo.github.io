...
For an _α-approximation algorithm_, $\alpha$ will be called the **performance guarantee** of the algorithm, in some literature also known as the **approximation ratio** or **approximation factor** of the algorithm.
