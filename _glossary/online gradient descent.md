...
Note: no assumptions on how $f_1,…,f_T$ relate to each other, allowing even for these to be chosen _adversarially_, e.g. with $f_i$ depending on our choice of $\mathbf{x}_i$ and all previous choices.
