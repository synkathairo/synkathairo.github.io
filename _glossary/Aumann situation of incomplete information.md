...
An **Aumann situation of incomplete information** over a set of _states of nature_ $S$ is a quintuple $(N, Y, (\mathcal{F}_i)_{i \in N}, \mathfrak{s}, \omega_*)$, where $(N, Y, (\mathcal{F}_i)_{i \in N}, \mathfrak{s})$ is an [[Aumann model of incomplete information]] and $\omega_* \in Y$.

State $\omega_*$ is the "_true state of the world_", each player knows the partition element $F_i (\omega_*)$ in his information partition that contains the true state.
...
1. M. Maschler, E. Solan, and Shmuel Zamir, _Game Theory_, Cambridge University Press, 2013, p. 324.
