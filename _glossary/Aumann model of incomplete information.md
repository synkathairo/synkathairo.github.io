...
Let $S$ be a [[finite set]] of *states of nature*. An **Aumann model of incomplete information** over set $S$ of states of nature consists of four components $(N, Y, (\mathcal{F}_i)_{i \in N}, \mathfrak{s})$ where
...
Event $A$ *obtains* in state of world $\omega$ if $\omega \in A$.
...
More generally, *knowledge operator* $K_i$ of player $i$ satisfies [[S5 modal logic#Kripke's S5 system (formulated via knowledge operators)|Kripke's S5 system]].
