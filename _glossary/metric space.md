...
## Notes
- can always define a *Borel measure* in a *metric space* using the [[σ-algebra|sigma algebra]] generated by [[open set|open sets]].
- *metric spaces* are [[Hausdorff space|Hausdorff]] ($T_2$)
