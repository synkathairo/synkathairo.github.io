...
A _two-player game_ is a [[zero-sum game|zero-sum game]] if for each pair of _strategies_ $(s_I, s_{II})$ one has
...
1. M. Maschler, E. Solan, and Shmuel Zamir, _Game Theory_, Cambridge University Press, 2013, pp. 111-116.
2. T. Başar and G.J. Olsder, _Dynamic Noncooperative Game Theory_, 2nd edition, Classics in Applied Mathematics, SIAM, Philadelphia, 1999.
