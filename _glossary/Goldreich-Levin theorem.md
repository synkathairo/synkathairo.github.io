...
If $f$ is a [[one-way function]], then $g(x,r) = (f(x),r)$ is also a *one-way function* and $hc(x,r) = \langle x,r \rangle = \sum (x_i \cdot r_i) (\mod 2)$ is a [[hard-core predicate]] of $g$.
