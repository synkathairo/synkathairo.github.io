...
Let $X_1, X_2,...$ be [[independent and identically distributed|i.i.d.]] [[random variable|random variables]] with [[expectation|expected value]] $\mathbb{E}[X_i] = \eta$ and _finite_ [[variance]] $\operatorname{Var}(X_i) = \sigma^2$, and define $Y_n$ as
$$Y_n = \frac{X_1 + ... + X_n}{n}$$
