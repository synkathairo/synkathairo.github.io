...
When _NDTM_ $M$ computers a function, it makes an arbitrary choice on which of two transition functions to apply.
...
1. S. Arora, B. Barak. _Computational Complexity: A Modern Approach_, Cambridge University Press, 2009, p. 41.
