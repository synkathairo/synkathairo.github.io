...
---
## Definition
Consider $F$ class of $n$-variable functions $f: \{0,1\}^n \to \{0,1\}$ . Let $\textsf{OPT}_\mathcal{N}$ be [[expectation|expected]] *evaluation cost* of *optimal non-adaptive strategy* on function $f$ under costs $c$, probabilities $p$. Similarly $\textsf{OPT}_\mathcal{A}$ for *optimal adaptive strategy* on $f$. Then, the **adaptivity gap** of the function class $F$ is
