...
lecture: 
statement: 
created: 2025-03-18T17:27:57-04:00
tags:
  - graph_theory
---
## Conjecture
For every $k \geq 1$, there exists an $n$-node graph with $\Omega(n^{1+1/k})$ edges and *girth* at least $2k+2$.
...
2. Paul Erdős. Extremal problems in graph theory. In *IN THEORY OF GRAPHS AND ITS APPLICATIONS, PROC. SYMPOS. SMOLENICE*. Citeseer, 1964.
	...
	- P. Erdös and L. Moser, “An extremal problem in graph theory,” _J. Aust. Math. Soc._, vol. 11, no. 1, pp. 42–47, Feb. 1970, doi: [10.1017/S1446788700005954](https://doi.org/10.1017/S1446788700005954).