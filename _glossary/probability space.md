...
lecture:
  - ece6303-1
statement: The **probability space** $(S,\mathcal{F},P)$ is defined over *universal set* $S$ (the *sample space* in probability theory serves as the *universal set* from set theory in this context), [[Borel field]] of *events* $\mathcal{F}$ (the *event space*), and *probabilities* of these events $P$ (*probability measure*, which is a [[measure space]]).
created: 2025-04-13T19:15:27-04:00
tags:
  - probability
---
## Definition
