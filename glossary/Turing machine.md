...
- $\delta : Q \times \Gamma^k \to Q \times \Gamma^{k-1} \times \{\mathsf{L},\mathsf{S},\mathsf{R}\}^k$, where $k \geq 2$, _transition function_ of $M$, describing rules $M$ uses in performing each step.
...
1. S. Arora, B. Barak. _Computational Complexity: A Modern Approach_, Cambridge University Press, 2009, pp. 10-15.
