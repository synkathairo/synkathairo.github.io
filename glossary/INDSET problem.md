...
Consider the problem of finding a maximum sized _independent set_ ([[set]] of vertices without any common edges) in a graph. The corresponding [[decision problem|language]] is
...
1. S. Arora, B. Barak. _Computational Complexity: A Modern Approach_, Cambridge University Press, 2009, pp. 3, 39.
