...
## Definition (_multiplicative spanner_)
...
For every $k \geq 1$, there exists an $n$-node _graph_ with $\Omega(n^{1+1/k})$ edges and _girth_ at least $2k+2$. ([[Erdős girth conjecture]]) (unproven beyond small values of $k$)
