...
Every [[two-player zero-sum game|two-person zero-sum game]] feedback game, which has an [[extensive form game|extensive form]] comprised of a finite number of branches, admits a _saddle point_ in _behavioral strategies_.
