...
If $R_1$ and $R_2$ are [[search problem|search problems]] and $\mathscr{C}$ is a _complexity class_ then a $\mathscr{C}$ **Levin reduction** of $R_1$ to $R_2$ consists of three functions $g_1, g_2, g_3 \in \mathscr{C}$ satisfying
...
May denote [[class P|P]] _Levin reduction_ as simply _Levin reduction_.
